...
export class SkyBranceLinkShortener {
    ...
    */
    public async create(params: CreateLinkParams): Promise<ShortLinkData> {
        ...
        const res = await this.client.request<LinkResponse>('/link-shortner', {
            method: 'POST',
            body: JSON.stringify({
                url: params.url,
                alias: params.alias,
    ...
    */
    public async update(id: string, params: UpdateLinkParams): Promise<ShortLinkData> {
        ...
        const res = await this.client.request<LinkResponse>(`/link-shortner/${id}`, {
            method: 'PUT',
            body: JSON.stringify({
                url: params.url,
                alias: params.alias,
    ...
    */
    public async getById(id: string, numberOfPastDays?: number): Promise<LinkByIdData> {
        ...
        const endpoint = queryString ? `/link-shortner/${id}?${queryString}` : `/link-shortner/${id}`;
    ...
    */
    public async uploadOgImage(id: string, params: OgImageUploadParams): Promise<OgImageUploadData> {
        ...
        const res = await this.client.request<OgImageUploadResponse>(`/link-shortner/og-image/${id}`, {
            method: 'POST',
            body: JSON.stringify({
    ...
    */
    public async deleteById(id: string): Promise<DeleteLinkResponse> {
        ...
        return this.client.request<DeleteLinkResponse>(`/link-shortner/${id}`, {
            method: 'DELETE'
        });
    }
    ...
    public async getList(filters: ListLinksFilters = {}): Promise<PaginatedLinkResponse> {
        ...
        const queryString = queryParams.toString();
        const endpoint = queryString ? `/link-shortner?${queryString}` : '/link-shortner';
